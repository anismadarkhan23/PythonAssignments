...
get_filtered_data = lambda num: num % 2 == 0
...
def main():
    ...
    print(f"Filtered data which contains even elements is: {filtered_data}")
    print("----------------------------------------------------------------------")

    mapped_data = list(map(get_mapped_data, filtered_data))
    print(f"Mapped data with elements squared is: {mapped_data}")
    print("----------------------------------------------------------------------")

    reduced_data = reduce(get_reduced_data, mapped_data)
    print(f"Reduced data with addition of all numbers is: {reduced_data}")
    print("----------------------------------------------------------------------")
