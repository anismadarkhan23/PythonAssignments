...
def calculate_sum_of_odd_numbers_till(number):
    ...
    print(f"Sum of Odd numbers till {number} : {sum_of_odd_numbers}")
...
def main():
    ...
    pool_obj = Pool()
    pool_obj.map(calculate_sum_of_odd_numbers_till, given_list_of_integers)
    pool_obj.close()
    pool_obj.join()
